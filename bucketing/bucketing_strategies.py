...
def get_latency_from_simulator(structured_bwd_gms: List[Union[fx.GraphModule, Set[fx.GraphModule]]], buckets:List[List[BucketElement]]):
    pass

def static_bucketing(buckets:List[List[BucketElement]], structured_bwd_gms: List[Union[fx.GraphModule, Set[fx.GraphModule]]], l_bucket_size:int, r_bucket_size:int):
    ...
    def binary_search_bucket_size(buckets:List[List[BucketElement]], l_bucket_size:int, l_latency:float, r_bucket_size:int, r_latency:float):
        ...
        #search for a bucket size between l and m
            return binary_search_bucket_size(buckets, l_bucket_size, l_latency, m_bucket_size, m_latency)
        else:
        #search for a bucket size between m and r
            return binary_search_bucket_size(buckets, m_bucket_size, m_latency, r_bucket_size, r_latency)
...
def dynamic_bucketing(buckets:List[List[BucketElement]], structured_bwd_gms: List[Union[fx.GraphModule, Set[fx.GraphModule]]]):
